...
import com.example.education_app.BusDetails_Activity;
import com.example.education_app.HitSOS_Activity;
import com.example.education_app.LiveTrackBus_Activity;
...
import com.example.education_app.MyRouteDetails_Activity;
...
import com.example.education_app.TransportFeeDetails_Activity;

import java.util.List;

public class TransportSystem_Adapter extends RecyclerView.Adapter<TransportSystem_Adapter.MyViewHolder> {

    Context context;
    List<Cities_Model> school_cats;

    public TransportSystem_Adapter(Context context, List<Cities_Model> school_cats) {
    ...
    public void onBindViewHolder(@NonNull final MyViewHolder holder, final int position) {
        ...
        holder.school_cat.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                switch (position){
                    case 0:
                        intent =  new Intent(context, MyRouteDetails_Activity.class);
                        break;
                    case 1:
                        intent =  new Intent(context, TransportFeeDetails_Activity.class);
                        break;
                    case 2:
                        intent =  new Intent(context, BusDetails_Activity.class);
                        break;
                    case 3:
                        intent =  new Intent(context, LiveTrackBus_Activity.class);
                        break;
                    case 4:
                        intent =  new Intent(context, HitSOS_Activity.class);
                        break;
