...
public class MyProfile_Adapter extends RecyclerView.Adapter<MyProfile_Adapter.MyViewHolder> {
    ...
    public MyProfile_Adapter(Context context, List<Cities_Model> school_cats) {
    ...
    public void onBindViewHolder(@NonNull final MyViewHolder holder, final int position) {
        ...
        holder.school_cat.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                switch (position){
                    case 0:
                        intent =  new Intent(context, MyParentDetails_Activity.class);
                        break;
                    case 1:
                        intent =  new Intent(context, MyBio_Activity.class);
                        break;
