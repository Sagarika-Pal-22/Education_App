...
import com.example.education_app.FeeNotification_Activity;
import com.example.education_app.FeeStructure_Activity;
...
import com.example.education_app.OnlinePayment_Activity;
...
public class MyFees_Adapter extends RecyclerView.Adapter<MyFees_Adapter.MyViewHolder> {

    Context context;
    List<Cities_Model> school_cats;

    public MyFees_Adapter(Context context, List<Cities_Model> school_cats) {
    ...
    public void onBindViewHolder(@NonNull final MyViewHolder holder, final int position) {
        ...
        holder.school_cat.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                switch (position){
                    case 0:
                        intent =  new Intent(context, FeeStructure_Activity.class);
                        break;
                    case 1:
                        intent =  new Intent(context, FeeNotification_Activity.class);
                        break;
                    case 2:
                        intent =  new Intent(context, OnlinePayment_Activity.class);
                        break;
                    case 3:
