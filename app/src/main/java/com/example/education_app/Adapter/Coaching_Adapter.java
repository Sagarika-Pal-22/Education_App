...
import com.example.education_app.CoachingDetails_Activity;
...
public class Coaching_Adapter extends RecyclerView.Adapter<Coaching_Adapter.MyViewHolder> {

    Context context;
    List<School_Model> school_models;

    public Coaching_Adapter(Context context, List<School_Model> school_models) {
    ...
    public void onBindViewHolder(@NonNull final MyViewHolder holder, final int position) {
        ...
        holder.linear_school.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(context, CoachingDetails_Activity.class);
