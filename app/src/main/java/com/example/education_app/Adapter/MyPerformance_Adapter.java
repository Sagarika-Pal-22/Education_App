...
public class MyPerformance_Adapter extends RecyclerView.Adapter<MyPerformance_Adapter.MyViewHolder> {

    Context context;
    List<Cities_Model> school_cats;

    public MyPerformance_Adapter(Context context, List<Cities_Model> school_cats) {
    ...
    public void onBindViewHolder(@NonNull final MyViewHolder holder, final int position) {
        ...
        holder.school_cat.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                switch (position){
                    case 0:
                        intent =  new Intent(context, StudentPerformanceGraph_Activity.class);
                        break;
                    case 1:
                        intent =  new Intent(context, OtherActivityGraph_Activity.class);
                        break;
                    case 2:
                        intent =  new Intent(context, BehaviorPattern_Activity.class);
                        break;
                    case 3:
                        intent =  new Intent(context, MyReportCard_Activity.class);
                        break;
                    case 4:
                        intent =  new Intent(context, MyMarkSheet_Activity.class);
                        break;
                    case 5:
                        intent =  new Intent(context, Attendance_Activity.class);
                        break;
