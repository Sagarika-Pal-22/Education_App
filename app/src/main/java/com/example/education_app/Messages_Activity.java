    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                LayoutInflater inflater = LayoutInflater.from(Messages_Activity.this);
                ...
                ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(Messages_Activity.this, android.R.layout.simple_dropdown_item_1line, teacher);
                ...
                date.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        DatePickerDialog datePickerDialog = new DatePickerDialog(Messages_Activity.this, new DatePickerDialog.OnDateSetListener() {
                            @Override
