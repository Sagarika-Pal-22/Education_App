...
public class NearbySchoolFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View root = inflater.inflate(R.layout.fragment_nearby_school,container,false);

        nearby_models =new ArrayList<>();

        rv_school = root.findViewById(R.id.rv_school);
        rv_school.setHasFixedSize(true);
        rv_school.setLayoutManager(new LinearLayoutManager(getActivity(),LinearLayoutManager.VERTICAL,false));
        ...
        rv_school.setAdapter(nearby_adapter);
        return root;
    }
