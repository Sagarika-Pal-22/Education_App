...
import com.example.education_app.Adapter.Nearby_Adapter;
...
public class PrivateTutorsFragment extends Fragment {

    RecyclerView rv_pTutors;
    List<Nearby_Model> nearby_models;
    Nearby_Adapter nearby_adapter;
    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View root =inflater.inflate(R.layout.fragment_private_tutors,container,false);

        nearby_models =new ArrayList<>();

        rv_pTutors = root.findViewById(R.id.rv_pTutors);
        rv_pTutors.setHasFixedSize(true);
        rv_pTutors.setLayoutManager(new LinearLayoutManager(getActivity(),LinearLayoutManager.VERTICAL,false));
        ...
        rv_pTutors.setAdapter(nearby_adapter);
        return root;
    }
    ...
    public class Nearby_Adapter extends RecyclerView.Adapter<Nearby_Adapter.MyViewHolder> {
        ...
        public void onBindViewHolder(@NonNull final Nearby_Adapter.MyViewHolder holder, final int position) {
            ...
            holder.btn_admission.setVisibility(View.GONE);
